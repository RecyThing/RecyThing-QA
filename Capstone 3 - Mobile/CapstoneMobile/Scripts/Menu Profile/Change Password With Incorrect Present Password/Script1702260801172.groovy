...
Mobile.setText(findTestObject('Menu Profile/Ubah Password/Kata sandi sekarang Press'), '123456789', 0)
...
Mobile.setText(findTestObject('Menu Profile/Ubah Password/Confirm Password'), '12345678', 0)
