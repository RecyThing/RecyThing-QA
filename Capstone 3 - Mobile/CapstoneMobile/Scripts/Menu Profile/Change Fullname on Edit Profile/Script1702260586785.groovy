...
Mobile.setText(findTestObject('Menu Profile/Profile saya Folder/Nama Lengkap Press'), 'Jiddan QA Mantap', 0)

Mobile.tap(findTestObject('Menu Profile/Profile saya Folder/Alamat Field'), 0)

Mobile.setText(findTestObject('Menu Profile/Profile saya Folder/Alamat Field'), 'JL.', 0)
