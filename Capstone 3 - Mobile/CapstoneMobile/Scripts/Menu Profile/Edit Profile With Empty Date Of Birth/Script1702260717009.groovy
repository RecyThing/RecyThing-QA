...
Mobile.tap(findTestObject('Menu Profile/Profile saya Folder/Nama Lengkap Field'), 0)

Mobile.setText(findTestObject('Menu Profile/Profile saya Folder/Nama Lengkap Press'), 'Jiddan QA Handal', 0)

Mobile.tap(findTestObject('Menu Profile/Profile saya Folder/Alamat Field'), 0)

Mobile.setText(findTestObject('Menu Profile/Profile saya Folder/Alamat Field'), 'JL. Mamang Koral', 0)
