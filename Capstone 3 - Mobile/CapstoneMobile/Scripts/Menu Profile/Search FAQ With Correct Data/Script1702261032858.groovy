...
Mobile.setText(findTestObject('Menu Profile/FAQ/Cari Pertanyaan press'), 'daur ulang', 0)

Mobile.verifyElementExist(findTestObject('Menu Profile/FAQ/Validasi Search with word daur ulang'), 0)
