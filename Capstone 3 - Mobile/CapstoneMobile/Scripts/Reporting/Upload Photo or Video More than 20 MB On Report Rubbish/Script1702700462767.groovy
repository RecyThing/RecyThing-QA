...
Mobile.tap(findTestObject('Reporting/Report Rubbish/Video diatas 20 mb'), 0)

Mobile.delay(3, FailureHandling.STOP_ON_FAILURE)

Mobile.verifyElementExist(findTestObject('Reporting/Report Rubbish/Validasi File Terlalu besar'), 0)
