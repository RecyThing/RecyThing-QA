...
Mobile.setText(findTestObject('Reporting/Report Rubbish/Search Map Report Rubbish Press'), 'MarshaJKT48', 0)

Mobile.verifyElementExist(findTestObject('Reporting/Report Rubbish/Validasi Random Keyword and Empty Search'), 0)
