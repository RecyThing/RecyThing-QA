...
Mobile.tap(findTestObject('Reporting/Report Company/Explain Report Company'), 0)

Mobile.verifyElementExist(findTestObject('Reporting/Report Company/Validasi Explanation Company'), 0)
