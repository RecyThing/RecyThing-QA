...
Mobile.setText(findTestObject('RecyBot/Text Field Press'), 'Cara Mendaur Ulang Sampah', 0)
...
Mobile.setText(findTestObject('RecyBot/Text Field Press'), 'Cara Mendaur Ulang Limbah', 0)
