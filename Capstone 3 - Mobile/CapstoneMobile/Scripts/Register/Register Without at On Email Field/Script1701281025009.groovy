...
Mobile.setText(findTestObject('Register Page/Nama Lengkap Field'), 'jiddan', 0)

Mobile.tap(findTestObject('Register Page/Email Field'), 0)

Mobile.setText(findTestObject('Register Page/Email Field'), 'jiddanexample.com', 0)

Mobile.tap(findTestObject('Register Page/Password Field'), 0)

Mobile.setText(findTestObject('Register Page/Password Field'), 'jiddan', 0)

Mobile.tap(findTestObject('Register Page/Confirm Password Field'), 0)

Mobile.setText(findTestObject('Register Page/Confirm Password Field'), 'jiddan', 0)
