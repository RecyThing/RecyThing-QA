...
Mobile.tap(findTestObject('Register Page/Kebijakan Privasi Button'), 0)

Mobile.verifyElementExist(findTestObject('Register Page/Validasi Privacy Police and term and Condition'), 0)
