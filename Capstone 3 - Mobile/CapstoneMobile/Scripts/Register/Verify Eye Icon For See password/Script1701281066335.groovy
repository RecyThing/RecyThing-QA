...
Mobile.tap(findTestObject('Register Page/Eye Icon 1'), 0)

Mobile.tap(findTestObject('Register Page/Eye Icon 2'), 0)

Mobile.verifyElementText(findTestObject('Register Page/Password Field'), '12345678')

Mobile.verifyElementText(findTestObject('Register Page/Confirm Password Field'), '12345678')
