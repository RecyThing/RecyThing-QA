...
WebUI.setText(findTestObject('Manajemen Transaksi/Daftar Voucher/Page_RecyThing Web/input_Daftar Voucher_chakra-input css-lohvid'), 
    'Shopee')

WebUI.verifyElementPresent(findTestObject('Manajemen Transaksi/Daftar Voucher/Page_RecyThing Web/p_Shopeepay 5k'), 0)
