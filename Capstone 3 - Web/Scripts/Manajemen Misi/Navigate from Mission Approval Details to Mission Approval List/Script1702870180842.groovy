...
WebUI.click(findTestObject('Manajemen Misi/Page_RecyThing Web/div_Approval Misi'))

WebUI.click(findTestObject('Manajemen Misi/Page_RecyThing Web/View-Approval Misi-All'))

WebUI.click(findTestObject('Manajemen Misi/Page_RecyThing Web/button_Kembali-View-Approval Misi-All'))

WebUI.verifyElementPresent(findTestObject('Manajemen Misi/Page_RecyThing Web/Search-Approval Misi'), 0)
